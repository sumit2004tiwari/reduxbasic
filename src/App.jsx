...
import {useGetProductbyCategoryQuery, useGetSortProductQuery} from './slice/apiSlice'
...
const {data :category , error : categoryerror , isLoading : categoryloading } = useGetProductbyCategoryQuery()
const {data : smartphone , error :smartphoneerror , isLoading : loadingsmartphone} = useGetSortProductQuery()
...
function handleOnchange (e){
  ...
  return (
    <>
      ...
      {smartphoneerror && <p>Error fetching data : {smartphoneerror.message}</p>}
      {
        smartphone && smartphone.products.map((daata , ind)=> (
          <div key={ind}>
